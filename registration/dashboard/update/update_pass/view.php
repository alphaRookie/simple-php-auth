        ...
        <header>
            ...
            <form action="controller.php" method="post">
                <div class="field">
                    ...
                    <input type="password" name="password" id="password" autocomplete="off" placeholder="New Password" required>
                </div>
                ...
                <div class="field">
                    <button type="submit" name="submit" class="button" value="Update Password">Update Password</button>
                </div>
            </form>
        </div><!--box form-box-->
        </div><!--container-->
